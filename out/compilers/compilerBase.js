...
class CompilerBase {
    ...
    async LoadConfigurationAndSettingsAsync() {
        ...
        switch (chosenCompiler.toLowerCase()) {
            case "make":
                ...
                const result = await this.ValidateTerminalMakeFileAvailableAysnc();
                if (result)
    ...
    async ValidateTerminalMakeFileAvailableAysnc() {
    ...
    async ValidateCustomCompilerLocationAsync(customCompilerId) {
    ...
    async VerifyCompiledFileSizeAsync() {
    ...
    async MoveFilesToBinFolderAsync() {
    ...
    async RemoveDebuggerFilesAsync(folder) {
    ...
    async FindTerminalMakeFileAsync(fileName) {
