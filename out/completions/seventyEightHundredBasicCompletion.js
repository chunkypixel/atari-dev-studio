...
class SeventyEightHundredBasicCompletion extends completionBase_1.CompletionBase {
    ...
    RegisterAsync(context) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            // add items           
            context.subscriptions.push(ifProvider, returnProvider, romsizeProvider, displayModeProvider, shakescreenModeProvider, deprecatedModeProvider, drawhiscoresProvider, tallsrpiteModeProvider, setProvider);
        });
    }
}
