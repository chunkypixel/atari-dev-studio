...
/*
    MS 1/10/24
    Custom vesion of UPNG 2.1.0
    - Changed the encode.compress routine to specially validate
      the PLTE (palette) area inline with how 7800basic uses
      the png to colorise a sprite
*/
;
(function () {
    var UPNG = {};
    ...
    (function (UPNG, pako) {
        ...
        UPNG.encode.compress = function (bufs, w, h, ps, forGIF, forbidPlte) {
            ...
            // Customisation for SpriteEditor
            // We use the manual method to scan for colors - this will match what 7800basic wants
            var gotAlpha = false;
            var cmap = {}, plte = [];
